...
class _TimePickerSpinnerState extends State<TimePickerSpinner> {
  ...
  double defaultItemWidth = 30; // 45
  double defaultSpacing = 71;
  ...
  DateTime getDateTime() {
    ...
    if(!widget.is24HourMode && apMode == 1) hour += 12;
  ...
  void initState() {
    ...
    apMode = currentTime.hour >= 12  ? 1 : 0;  
      ...
      onNotification: (scrollNotification){
        if(scrollNotification is UserScrollNotification){
          if(scrollNotification.direction.toString() == "ScrollDirection.idle") {
            ...
            setState(() {
              onScrollEnd();
              widget.setCurrentSelectedTime(getDateTime());
            });
          }
        }
      ...
      children: <Widget>[
        FlatButton(  
          ...
          child: Text(  
            'AM',
            style: TextStyle(  
              color: apMode == 0 ? Colors.white : Colors.white38,
        ...
        FlatButton(
          ...
          child: Text(  
            'PM',
            style: TextStyle(   
              color: apMode == 1 ? Colors.white : Colors.white38,
              fontFamily: Fonts.standard,
              fontSize: 16
            ),
          ),
