...
const DATETIME_PICKER_BACKGROUND_COLOR = Colors.black;
...
const TextStyle DATETIME_PICKER_ITEM_TEXT_STYLE =
    const TextStyle(color: Colors.white, fontSize: 16.0, fontFamily: 'RobotoMono');

const Color DATETIME_PICKER_ITEM_TEXT_COLOR = Colors.white;
